            ...
            <div className='flex justify-between items-center w-full h-full px-2 2xl:px-16'>
                ...
                <div className=''>
                    <ul className='hidden md:flex'>
                        <Link href='/#main'>
                            <li className='ml-10 uppercase hover:border-b cursor-pointer'>Inicio
                            </li>
                        </Link>
                        <Link href='/#about'>
                            <li className='ml-10 uppercase hover:border-b  cursor-pointer'>Sobre mí
                            </li>
                        </Link>
                        <Link href='/#skills'>
                            <li className='ml-10 uppercase hover:border-b  cursor-pointer'>Habilidades
                            </li>
                        </Link>
                        <Link href='/#projects'>
                            <li className='ml-10 uppercase hover:border-b  cursor-pointer'>Proyectos
                            </li>
                        </Link>
                        <Link href='/#contact'>
                            <li className='ml-10 uppercase hover:border-b  cursor-pointer'>Contacto
                            </li>
                        </Link>
                    </ul>
