...
import ImagenPython from '../public/assets/python.svg';
...
import ImagenExpress from '../public/assets/expressjs-icon.svg';
import ImagenNode from '../public/assets/nodejs-icon.svg';
  ...
  return (
    <div id='skills' className=''>
        ...
        <div className='flex flex-col md:space-between md:flex-col justify-center items-center w-full h-screen md:px-30'>
            ...
            <div className='w-100'>
                <h3 className='text-center my-5'>Tecnologías</h3>
                <div className='flex'>
                    ...
                    <div className='mx-3 md:mx-5 shadow-lg shadow-slate-300/30 rounded-md p:1 md:p-2 hover:shadow-slate-300/60 ease-in duration-300 hover:scale-105 hover:bg-slate-300'>
                        <Image
                        src={ImagenExpress}
                        alt='/'
                        width='80'
            ...
            <div className='w-100'>
                <h3 className='text-center my-5'>Otras tecnologías:</h3>
